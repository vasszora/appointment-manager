...
insert into appointment(start_time, duration, price, description, user_id) values(parsedatetime('2022-11-20 19:00','YYYY-MM-DD HH:mm'), 120, 100, 'Hairdresser: cut and color', (select id from users where username = 'username1'));
